...
exports.tokeniseMessage = tokeniseMessage;
...
exports.getEmoteTokens = getEmoteTokens;
...
exports.getCheermoteTokens = getCheermoteTokens;
const parseEmotes = (message, emotes) => tokeniseMessage(message, getEmoteTokens(message, emotes));
exports.parseEmotes = parseEmotes;
const parseCheermotes = (message, cheermotes) => tokeniseMessage(message, getCheermoteTokens(message, cheermotes));
exports.parseCheermotes = parseCheermotes;
...
const getMessageDetails = (message, userstate = {}) => ({
    ...
    tokens: parseTokens(message, (token) => parseEmotes(token, userstate.emotes)),
    raw: message,
});
